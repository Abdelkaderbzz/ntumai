...
type CreateBrandNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'CreateBrand'
>;

const CreateBrand = () => {
  const navigation = useNavigation<CreateBrandNavigationProp>();
            ...
            <View className='mb-4'>
              ...
              <TouchableOpacity className='flex-row bg-white items-center justify-between rounded-full p-4 border border-gray-200'>
                <View className='flex-row items-center'>
                  <Package name='settings-outline' size={20} color='#666' />
