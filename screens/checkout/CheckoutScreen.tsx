      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-white mx-4 mt-4 p-4 rounded-2xl shadow-sm">
          ...
          {mockCartItems.map((item) => (
            <View
              key={item.id}
              className="flex-row items-center mb-3 pb-3 border-b border-gray-100 last:border-b-0"
            >
              <Image
        ...
        <View className="bg-white rounded-2xl p-4 mb-6 shadow-sm">
          ...
          {orderSteps.map((step, index) => (
            <View key={step.id} className="flex-row items-start mb-4 last:mb-0">
              <View
                className={`w-6 h-6 rounded-full items-center justify-center mr-4 mt-1 ${
            ...
            <View className="flex-row items-center">
              ...
              <View className="flex-1 ml-4">
                ...
                <View className="flex-row items-center mt-1">
                  ...
                  <Text
                    style={{ fontFamily: "Ubuntu-Regular" }}
                    className="text-gray-600 ml-1 text-sm"
                  >
                    4.8 (245 trips)
                  </Text>
                </View>
